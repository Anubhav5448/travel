...
function Page2() {
  return (
    <div className="flex flex-col items-center my-28 gap-10">
      <h1 className="text-6xl font-semibold">Find Popular Destinations</h1>
      <h4 className="text-center text-lg font-semibold">
        Take a look at our most rated popular visitong tourist spots. <br /> Our
        most popular place for foreign tourists.
      </h4>

      <div className="flex gap-14 justify-around w-full ">
